---
name: md-general-analysis-planning
description: Handle non-mutating requests such as search, analysis, estimation, and planning across this workspace with strict scope mapping, explicit assumptions, and concise high-signal output.
---

# MD General Analysis Planning

Use this skill for non-mutating requests.

## Required flow
1. Clarify objective and scope boundaries.
2. Gather facts from workspace and runtime context.
